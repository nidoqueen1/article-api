...
func (_m *IDatabase) CreateArticle(article *entity.Article) error {
...
func (_m *IDatabase) GetArticle(articleID uint) (*entity.Article, error) {
...
func (_m *IDatabase) GetArticlesByTagAndDate(tagName string, date time.Time) ([]*entity.Article, int64, error) {

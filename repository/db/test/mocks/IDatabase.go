...
func (_m *IDatabase) CreateArticle(ctx context.Context, article *entity.Article) error {
...
func (_m *IDatabase) GetArticle(ctx context.Context, articleID uint) (*entity.Article, error) {
...
func (_m *IDatabase) GetArticlesByTagAndDate(ctx context.Context, tagName string, date time.Time) ([]*entity.Article, int64, error) {
